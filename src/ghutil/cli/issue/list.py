...
@click.option(
    "-c", "--creator", metavar="USER", help="Only show issues created by the given user"
)
@click.option(
    "-l",
    "--label",
    multiple=True,
    metavar="LABEL",
    help="Only show issues with the given label." "  May be specified multiple times",
)
@click.option(
    "--mentioned", metavar="USER", help="Only show issues mentioning the given user"
)
@click.option(
    "-m",
    "--milestone",
