...
@click.option(
    ...
    default=True,
    help="Allow merging PRs with merge commits?",
    show_default=True,
)
@click.option(
    "--allow-rebase-merge/--no-rebase-merge",
    default=True,
    help="Allow rebase-merging PRs?",
    show_default=True,
)
@click.option(
    "--allow-squash-merge/--no-squash-merge",
    default=True,
    help="Allow squash-merging PRs?",
    show_default=True,
)
@click.option(
    "--auto-init/--no-init",
...
@click.option(
    "-O", "--organization", help="Create the repository in the given organization"
)
@click.option(
    "-P/-p",
    "--private/--public",
...
@optional(
    "--team", metavar="ID|NAME", help="Grant the given team access to the repository"
)
